...
@Builder
public record HuntResponseDto(Long id, String competition_code, String fish_name, Double fish_averageWeight, Integer numberOfFish, Integer member_number, String member_name) {
